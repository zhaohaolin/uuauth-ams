...
import com.toolkit.lang.XmlConverter;
import com.uuauth.ams.domain.entity.EmployeeInfo;
import com.uuauth.aps.domain.service.UserMapService;
...
public class UserMapServiceImpl implements UserMapService {
	 ...
	 * 
	 * @see
	 * com.auth.server.application.UserMapService#cacheToken(java.lang.String,
	 ...
	 * 
	 * @see
	 * com.auth.server.application.UserMapService#checkToken(java.lang.String,
	 * java.lang.String)
	 */
	@Override
	...
	public boolean addUser(String id) {
		String url = authGetUserUrl + "?id=" + id + "&token=" + token
				+ "&check=" + SecurityUtil.MD5(id + password + token);
		String xml = WebClient.retrieveWebContent(url);
		try {
			xml = new String(xml.getBytes("utf-8"), "iso8859-1");
		} catch (UnsupportedEncodingException e1) {
	 ...
	 * 
	 * @see
	 * com.auth.server.application.UserMapService#getUser(java.lang.Integer)
	 */
	@Override
